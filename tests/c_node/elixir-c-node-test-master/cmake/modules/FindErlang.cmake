...
file(GLOB EI_LIBRARIES "${ERLANG_EI_LIBRARY_PATH}/*.a")
SET(ERLANG_EI_LIBRARIES ${EI_LIBRARIES})

SET(ERLANG_ERTS_PATH ${ERLANG_OTP_ROOT_DIR}/${ERLANG_ERTS_DIR})
SET(ERLANG_FOUND ${ERLANG_ERTS_PATH})
...
file(GLOB ERTS_LIBRARIES "${ERLANG_ERTS_LIBRARY_PATH}/*.a")
